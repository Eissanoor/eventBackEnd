...
const FATSDB = {
  ...
  async getAllAssetMasterEncodeAssetCapture(req, res, next) {
    try {
      ...
      const data = await connection.query(
        `SELECT * FROM TblAssetMasterEncodeAssetCapture`
      );
      console.log(data);
  ...
  async getAllAssetMasterEncodeAssetCaptureFinal(req, res, next) {
    try {
      ...
      console.log("connection working ");
      const data = await connection.query(
        `SELECT * FROM TblAssetMasterEncodeAssetCaptureFinal`
      );
      console.log(data);
      return res.send(data);
    } catch (e) {
  ...
  async getAllAssetRequestMaster(req, res, next) {
    try {
      ...
      console.log("connection working ");
      const data = await connection.query(
        `SELECT * FROM TblAssetRequestMaster`
      );
      console.log(data);
      return res.send(data);
    } catch (e) {
  ...
  async getAllAssetRequestDetails(req, res, next) {
    try {
      ...
      console.log("connection working ");
      const data = await connection.query(
        `SELECT * FROM TblAssetRequestDetails`
      );
      console.log(data);
      return res.send(data);
    } catch (e) {
  ...
  async getAllMAINSUBSeriesNoAssigned(req, res, next) {
    try {
      ...
      console.log("connection working ");
      const data = await connection.query(
        `SELECT * FROM TblMAINSUBSeriesNoAssigned`
      );
      console.log(data);
      return res.send(data);
    } catch (e) {
  ...
  async getAllUsersRolesAssigned(req, res, next) {
    try {
      ...
      console.log("connection working ");
      const data = await connection.query(
        `SELECT * FROM TblUsersRolesAssigned `
      );
      console.log(data);
      return res.send(data);
    } catch (e) {
